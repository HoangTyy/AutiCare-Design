...
2. **Admin Dashboard**: 
    ...
    - **Decoupled Sub-Tabs (`src/components/dashboard/`)**:
        ...
        - `AdminProfileTab.tsx`: [NEW] Phân hệ quản lý hồ sơ cá nhân của Admin có thiết kế tối Midnight Indigo sang trọng, hỗ trợ song ngữ, 10 trường thông tin chi tiết, responsive 100% và cơ chế View/Edit linh hoạt. Tích hợp đồng bộ trực tiếp vào Sidebar footer tài khoản (.user-profile).
