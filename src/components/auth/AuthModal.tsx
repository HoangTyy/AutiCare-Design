...
const authCopy = {
  vi: {
    ...
    register: 'Register',
    close: 'Dong modal',
    emailPlaceholder: 'ten@auticare.vn',
    namePlaceholder: 'Nguyen Minh Anh',
    passwordPlaceholder: 'Nhap mat khau',
    sampleEmail: 'admin@auticare.vn',
    samplePassword: 'auticare-admin',
    sampleNote: 'Tai khoan mau da duoc dien san. Bam Dang nhap de vao ngay.',
  },
  en: {
    eyebrow: 'AUTICARE ACCESS',
    signInTitle: 'Sign in',
    ...
    register: 'Register',
    close: 'Close modal',
    emailPlaceholder: 'name@auticare.vn',
    namePlaceholder: 'Nguyen Minh Anh',
    passwordPlaceholder: 'Enter password',
    sampleEmail: 'admin@auticare.vn',
    samplePassword: 'auticare-admin',
    sampleNote: 'Demo account is prefilled. Press Sign in to continue.',
  },
};
